Kredi Kartı Sahtekarlığı Tespiti (Fraud Detection) Merhaba! Bu repoda, veri bilimindeki en klasik problemlerden biri olan aşırı dengesiz veri setleri (Imbalanced Data) üzerinde çalıştığım makine öğrenmesi projemi bulabilirsiniz.
